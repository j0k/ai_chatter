...
export class TelegramBotManager {
    ...
    private async initializeBuiltinPlugins(): Promise<void> {
        try {
            console.log('[AI-CHATTER v1.2.1] Initializing built-in plugins...');
            ...
            console.log('[AI-CHATTER v1.2.1] Built-in plugins initialized successfully');
            
        } catch (error) {
            console.error('[AI-CHATTER v1.2.1] Error initializing plugins:', error);
        }
    }
    ...
    private formatHelpMessage(): string {
        let help = `🤖 **AI-Chatter v1.2.1 Help & Commands**\n\n`;
        ...
        help += `• **Version**: Currently running v1.2.1\n`;
        ...
        try {
            ...
            if (this.bot) {
                const sentFile = await this.bot.sendDocument(telegramChatId, tempFilePath, {
                    caption: `📁 ${fileName}\n📊 Size: ${fileSizeKB}KB\n🤖 Generated by AI Chatter v1.2.1\n📅 ${new Date().toISOString()}`
                });
